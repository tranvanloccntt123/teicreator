...
const BeautiJson = () => {
    ...
    const prettyPrintJson = {
      ...
      toHtml(data, options?: any) {
        ...
        const replacer = (match, ...parts) => {
          ...
          const findName = settings.quoteKeys
            ? /(.*)(): /
            : /"([\w$]+)": |(.*): /;
  ...
  return (
    <Box className="flex-1 bg-white">
      <pre ref={ref} id="account" className="json-container" />
    </Box>
  );
};

export default BeautiJson;
